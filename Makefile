...
GRAPHITE = -fgraphite -fgraphite-identity #-floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block -floop-flatten -floop-nest-optimize
...
HOSTCFLAGS   = $(GRAPHITE) -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 #-floop-nest-optimize
HOSTCXXFLAGS = $(GRAPHITE) -O3
...
CC		= $(srctree)/scripts/gcc-wrapper.py $(REAL_CC) $(GRAPHITE)
